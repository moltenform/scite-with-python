...
CXXFLAGS=-Zi -TP -MP -W4 -WX -EHsc -Zc:forScope -Zc:wchar_t -D_CRT_SECURE_NO_DEPRECATE=1 -D_CRT_NONSTDC_NO_DEPRECATE $(WIDEFLAGS) $(XP_DEFINE)
...
# don't need to build PROPS, we can copy properties manually
ALL: $(PROG) $(DLLS)
